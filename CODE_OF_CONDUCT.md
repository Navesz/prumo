...
project will identify a neutral community moderator before acting on a report
about the maintainer. Enforcement decisions are documented privately, applied
consistently, and disclose only the minimum public detail needed. Retaliation
against a reporter is itself a violation.

The Contributor Covenant is licensed under
[CC BY 4.0](https://creativecommons.org/licenses/by/4.0/); this file is
distributed under the same terms. The repository's software remains under
Apache-2.0 and the price catalog under CC BY 4.0.
